...
def refine_perm(perm):
    ...
    for p, o in old_perm.items():
        ...
        if "act_modules" not in o:
            # The last input module of each node is used as the module for counting the activation value.
        ...
        # Add split dim's tag (for multi-head attentation)
        for axis, w, cfg in weights:
            if "split_dim" in cfg:
